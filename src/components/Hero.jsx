...
const Hero = memo(function Hero() {
  return (
    <section className="bg-transparent min-h-screen flex flex-col justify-center px-6 sm:px-10 relative overflow-hidden">
      ...
      <div 
        className="absolute top-1/4 right-1/4 w-96 h-96 bg-purple-600 rounded-full opacity-10"
      />
      
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-white mb-6 sm:mb-8">
        ...
        <button
          ...
          className="mt-8 px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-purple-500/40 transition-all no-underline relative overflow-hidden group"
        >
      ...
      <div className="absolute bottom-10 left-0 right-0 mx-auto w-max flex flex-col items-center gap-2">
