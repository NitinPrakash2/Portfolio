  ...
  return (
    <section className="bg-transparent min-h-screen flex flex-col justify-center px-6 sm:px-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-white mb-6 sm:mb-8 section-fade-in">
          Building Scalable Web Solutions with Clean Code
        </h1>
        <p className="text-lg sm:text-xl md:text-2xl text-gray-400 max-w-2xl section-fade-in-delay-1">
        ...
        <button
          ...
          className="mt-8 px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-purple-500/40 transition-all no-underline relative overflow-hidden group section-fade-in-delay-2"
        >
      ...
      <div className="absolute bottom-10 left-0 right-0 mx-auto w-max flex flex-col items-center gap-2 section-fade-in-delay-2">
